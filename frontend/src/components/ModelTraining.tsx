  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-800">Cloudflare モデル学習</h3>
          <p className="text-sm text-gray-500">無料枠で動作する近似学習を実行</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        {success && (
          <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center gap-2">
            ...
            <span className="text-sm">Cloudflare モデルの学習が完了しました</span>
          </div>
        )}
        ...
        >
          <div className="flex items-center gap-2" style={{ color: '#ffffff' }}>
            ...
            <span className="text-sm font-medium">近似モデルを計算中...</span>
          </div>
