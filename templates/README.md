...
| カラム名 | 必須 | 説明 | 例 |
|---------|------|------|-----|
| メンバーコード | ✅ | 一意のメンバー識別子 | m999 |
| メンバー名 | ✅ | メンバーの名前 | 新規ユーザー |
...
- **メンバーコード**: システム内で一意である必要があります。既存メンバーと重複しないようにしてください
- **力量コード**: 力量マスター（skills/education/license）に存在するコードのみ有効です
- **レベル値**:
  - SKILL: 1-5の整数
  - EDUCATION/LICENSE: 1（習得済み）
- **同一メンバーの複数行**: 1人のメンバーが複数の力量を持つ場合、メンバーコードとメンバー名を繰り返し記述してください
