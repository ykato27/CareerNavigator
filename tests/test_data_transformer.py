...
class TestCreateCompetenceMaster:
    ...
    def test_competence_master_types(self, sample_skills, sample_education,
                                     sample_license, sample_categories):
        """3タイプすべてが含まれること"""
        data = {
            'skills': sample_skills,
    ...
    def test_competence_master_count(self, sample_skills, sample_education,
                                     sample_license, sample_categories):
        """件数が正しいこと"""
        data = {
            'skills': sample_skills,
    ...
    def test_competence_master_level_ranges(self, sample_skills, sample_education,
                                           sample_license, sample_categories):
        """レベル範囲が正しく設定される"""
        data = {
            'skills': sample_skills,
    ...
    def test_competence_master_category_names(self, sample_skills, sample_education,
                                              sample_license, sample_categories):
        """カテゴリ名が正しくマッピングされる"""
        data = {
            'skills': sample_skills,
...
class TestCreateMemberCompetence:
    ...
    def test_member_competence_level_normalization(self, sample_members, sample_competence_master):
        ...
        transformer = DataTransformer()
        member_comp, _ = transformer.create_member_competence(
            data, sample_competence_master
        )
    ...
    def test_member_competence_merge(self, sample_members, sample_acquired,
                                    sample_competence_master):
        """力量マスタとのマージが正しく行われる"""
