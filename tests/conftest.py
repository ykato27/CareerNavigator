...
def sample_members():
    ...
    return pd.DataFrame({
        ...
        'よみがな': ['たなかたろう', 'すずきはなこ', 'さとうじろう', 'たかはしみさき', 'いとうけんいち'],
...
def sample_categories():
    ...
    return pd.DataFrame({
        ...
        'カテゴリ2': ['プログラミング', 'データベース', 'インフラ', 'クラウド', '開発手法', 'セキュリティ', 'IT資格'],
        'カテゴリ3': ['', '', '', '', '', '', '']
    })
...
def sample_acquired():
    ...
    return pd.DataFrame({
        ...
        '力量タイプ': ['SKILL', 'SKILL', 'EDUCATION', 'SKILL', 'SKILL', 'SKILL', 'LICENSE', 'SKILL', 'SKILL'],
        'レベル': [3, 4, '●', 2, 3, 5, '●', 4, 3]
    })
...
def sample_competence_master():
    ...
    return pd.DataFrame({
        ...
        '力量カテゴリー名': ['技術 > プログラミング', '技術 > データベース', '技術 > プログラミング', '技術 > クラウド', '資格 > IT資格'],
        'レベル範囲': ['1-5', '1-5', '1-5', '●', '●']
    })
...
def sample_member_competence():
    ...
    return pd.DataFrame({
        ...
        '力量名': ['Python', 'SQL', 'AWS研修', 'Python', 'JavaScript', 'SQL', '基本情報技術者', 'Python', 'Docker'],
        '力量カテゴリー名': ['技術 > プログラミング', '技術 > データベース', '技術 > クラウド',
                             '技術 > プログラミング', '技術 > プログラミング', '技術 > データベース',
                             '資格 > IT資格', '技術 > プログラミング', '技術 > インフラ']
    })
