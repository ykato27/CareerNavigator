...
4. [Pages Functions APIモデル](#pages-functions-apiモデル)
...
CareerNavigator WebUI は、**React + TypeScript (Frontend)** と **Cloudflare Pages Functions (API)** で構築されたキャリアパス推薦システムです。
...
| **データストレージ** | D1 + R2（R2 未有効時は D1 フォールバック） |
...
sequenceDiagram
    ...
    participant B as Pages Functions
...
graph LR
    ...
    F -->|Pages Functions| G[Frontend表示]
```
...
- [WebUIガイド](../03-webui/WEBUI_GUIDE.md)
- [README](../../README.md)
- [アーキテクチャドキュメント](../05-architecture/ARCHITECTURE.md)
...
| バージョン | 日付 | 変更内容 |
|-----------|------|---------|
| 3.0 | 2026-03-28 | Cloudflare Pages Functions / D1 / R2 前提に更新 |
