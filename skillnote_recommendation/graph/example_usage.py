...
def example_1_basic_usage():
    ...
    member_competence = pd.DataFrame({
        ...
        '取得日': ['2024-01-01', '2024-02-15', '2024-04-01',
    ...
    for rec in recommendations:
        print(f"  {rec.rank}. {rec.skill_name} (スコア: {rec.score:.2f}, 信頼度: {rec.confidence:.2f})")
...
def example_2_enhanced_visualization():
    ...
    # 表示（Streamlitの場合は st.plotly_chart(fig)）
    print("可視化を生成しました")
    ...
    member_competence = pd.DataFrame({
        ...
        '力量コード': ['S001', 'S002', 'S003', 'S004', 'S005',
                     ...
                     ['S001', 'S002', 'S003', 'S005', 'S007',
                      'S008', 'S009', 'S010'],
        '取得日': [
            '2023-01-01', '2023-02-15', '2023-04-01', '2023-06-01', '2023-08-01',
            '2023-10-01', '2023-12-01', '2024-02-01', '2024-04-01', '2024-06-01'
        ] + [
            '2023-02-01', '2023-03-15', '2023-05-01', '2023-09-01', '2023-11-01',
