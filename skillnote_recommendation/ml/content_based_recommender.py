...
class ContentBasedRecommender:
    ...
    def recommend(self,
                  ...
                  category_filter: Optional[str] = None) -> List[Recommendation]:
        """コンテンツベース推薦を実行
        ...
        profile_scores = self._compute_profile_scores(
            candidate_comps,
            profile_key
        )
    ...
    def _compute_profile_scores(self,
                                competence_codes: List[str],
                                profile_key: str) -> Dict[str, float]:
